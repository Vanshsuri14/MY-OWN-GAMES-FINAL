class Form {
  ...
  display(){
    ...
    this.button1.position(displayWidth / 2 - 600, displayHeight / 2 - 300);
    this.button2.position(displayWidth / 2 + 400, displayHeight / 2 - 300);
    this.button3.position(displayWidth / 2 - 600, displayHeight / 2 + 60);
    this.button4.position(displayWidth / 2 + 400, displayHeight / 2 + 60);

    this.back.position(displayWidth / 2.25, displayHeight / 2 + 200);
    ...
    this.button2.mousePressed(() => {
      this.cricketContent();
      background("red");
      this.back.position(displayWidth / 2, displayHeight / 2 + 250);
